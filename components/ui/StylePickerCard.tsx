...
const StylePickerCard: React.FC<StylePickerCardProps> = ({
  ...
  <button
    ...
    className={`
      group flex min-h-[108px] flex-col rounded-2xl border p-2.5 text-left transition-all duration-200
  ...
  >
    <div
      className={`
        relative mb-2.5 h-11 w-full overflow-hidden rounded-xl ring-1 ring-black/5
