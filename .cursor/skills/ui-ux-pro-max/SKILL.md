---
name: ui-ux-pro-max
description: Provides design intelligence for building professional UI/UX across web and mobile. Generates design systems with styles, colors, typography, and UX guidelines. Use when the user requests UI/UX work such as building landing pages, dashboards, mobile apps, design reviews, or improving visual design.
---
...
**Script path:** Use `.cursor/skills/ui-ux-pro-max/scripts/search.py` (project) or `~/.cursor/skills/ui-ux-pro-max/scripts/search.py` (global). On Windows use `python` instead of `python3`.
