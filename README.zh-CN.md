...
- 拼豆图纸：将生成或上传的贴纸转换成带编号网格、品牌近似色板和材料清单的拼豆图纸。
- 使用帮助栏：图库右侧提供可滚动的工作流提示，包含拼豆、透明背景、贴纸集合和导出说明。
...
4. 生成居中的贴纸风格 PNG。
5. 在图库里检查素材状态。
6. 可将单张贴纸继续转换为拼豆图纸，并导出 PNG 图纸或包含色号、颜色名、参考 Hex、数量的 CSV 材料清单。
7. 下载单张 PNG，或选择多张后打包 ZIP 下载。
